...
{id:'tennisnyi-set', cat:'korzina', name:'Теннисный сет', price:5500, img:'img/katalog/tennisnyi-set.jpg',
 comp:[], lead:'Композиция в корзине с теннисными мячами — подарок для того, кто живёт кортом.'},
...
/* ══ СВАДЕБНЫЕ БУКЕТЫ ═════════════════════════════════ */
{id:'sv-rozovyi-sad', cat:'svadba', name:'Розовый сад', price:2700, from:true, img:'img/svadba/b-rozovyi-sad.jpg',
 comp:['Гвоздика','Молюцелла','Маттиола']},
{id:'sv-ornitogalum', cat:'svadba', name:'С орнитогалумом', price:3500, from:true, img:'img/svadba/b-ornitogalum.jpg',
 comp:['Эвкалипт','Эустома','Диантус','Орнитогалум']},
{id:'sv-gladiolus-anturium', cat:'svadba', name:'Гладиолус и антуриум', price:4000, img:'img/svadba/b-gladiolus-anturium.jpg',
 comp:['Гладиолус','Антуриум']},
{id:'sv-zelenyi-anturium', cat:'svadba', name:'Зелёный антуриум', price:4200, img:'img/svadba/b-zelenyi-anturium.jpg',
 comp:['Антуриум зелёный','Зелень']},
{id:'sv-kally', cat:'svadba', name:'Каллы', price:4300, img:'img/svadba/b-kally.jpg',
 comp:['Калла']},
{id:'sv-belyi-klassika', cat:'svadba', name:'Классический белый', price:4500, from:true, img:'img/svadba/b-belyi-klassika.jpg',
 comp:['Эвкалипт','Эустома','Роза','Диантус']},
{id:'sv-serruriya', cat:'svadba', name:'Серрурия', price:5000, img:'img/svadba/b-serruriya.jpg',
 comp:['Серрурия','Амарант']},
{id:'sv-romashkovyi', cat:'svadba', name:'Ромашковый', price:5000, img:'img/svadba/b-romashkovyi.jpg',
 comp:['Хризантема','Ромашка','Роза']},
{id:'sv-sbornyi-belyi', cat:'svadba', name:'Сборный белый', price:5000, from:true, img:'img/svadba/b-sbornyi-belyi.jpg',
 comp:['Эустома','Роза','Гвоздика','Зелень']},
{id:'sv-zelenyi', cat:'svadba', name:'Зелёный', price:5000, from:true, img:'img/svadba/b-zelenyi.jpg',
 comp:['Роза','Диантус','Львиный зев','Лизиантус','Амарант']},
{id:'sv-kalla-businy', cat:'svadba', name:'Калла и бусины', price:5700, img:'img/svadba/b-kalla-businy.jpg',
 comp:['Калла','Декоративные бусины']},
{id:'sv-liliya', cat:'svadba', name:'Лилия', price:6000, from:true, img:'img/svadba/b-liliya.jpg',
 comp:['Лилия']},
{id:'sv-polevoi-belyi', cat:'svadba', name:'Полевой белый', price:5000, img:'img/svadba/b-polevoi-belyi.jpg',
...
{id:'sv-polevoi', cat:'svadba', name:'Полевой яркий', price:6000, from:true, img:'img/svadba/b-polevoi.jpg',
 comp:['Сборный полевой состав']},
{id:'sv-vysokii-belyi', cat:'svadba', name:'Высокий белый', price:6200, img:'img/svadba/b-vysokii-belyi.jpg',
...
{id:'svecha-shaiba', cat:'svecha', name:'Свеча в шайбе', price:1000, img:'img/svechi/shaiba-venskii.jpg',
 ...
 lead:'Плоская жестяная шайба — помещается в сумку и в подарочный бокс к букету. Ароматы: арбуз и сахар, банановый круассан, белый чай и бергамот, бурбон и мёд, венский штрудель, табак и трюфель.'},
{id:'svecha-steklo', cat:'svecha', name:'Свеча в стекле', price:1100, img:'img/svechi/steklo-tri.jpg',
 ...
 lead:'Свеча в матовой банке с пробковой крышкой — та, что остаётся на полке и после того, как догорит.'},
{id:'sprei-room', cat:'svecha', name:'Рум-спрей', price:1000, img:'img/svechi/sprei-chetyre.jpg',
 ...
 lead:'Аромат для комнаты, текстиля и штор — два нажатия, и в доме пахнет так, как вы задумали.'},
...
{id:'cifra-25', cat:'shar', name:'Розовый кварц', price:4150, img:'img/shary/cifra25.jpg',
 comp:['Цифра','Шары в розовой гамме','Конфетти'],
 lead:'Готовая связка с цифрой и подобранными по цвету шарами. Цифру собираем любую — от одного знака до трёх.'},
