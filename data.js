...
{id:'sezon-osennyaya', cat:'sezon', name:'Осенний бархат', price:5500,
 ...
 comp:['Хризантема','Роза пионовидная','Гвоздика','Леукадендрон'],
 lead:'Осенний букет: пыльная роза, малиновая хризантема и тёмный леукадендрон. Глубокие ягодные оттенки, которые бывают только в эту пору.'},
...
{id:'sv-zhemchuzhnyi', cat:'svadba', name:'Жемчужный', price:7500, img:'img/svadba/b-zhemchuzhnyi.jpg',
 comp:['Роза пионовидная','Маттиола','Эвкалипт','Декоративные бусины','Бутоньерка для жениха'],
 lead:'Цена сразу с бутоньеркой для жениха — собираем их в паре, из тех же цветов.'},
...
{id:'sv-snezhnyi-shar', cat:'svadba', name:'Снежный шар', price:3000, img:'img/svadba/b-gvozdika-shar.jpg',
 comp:['Диантус','Декоративные бусины'],
 lead:'Плотный шар из белого диантуса на жемчужной нити — форма, которая не растреплется за день и хорошо читается на фото.'},
