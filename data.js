...
{id:'sv-belo-zelenyi', cat:'svadba', name:'Бело-зелёный', price:8000, img:'img/svadba/b-belo-zelenyi.jpg',
 comp:['Гербера','Львиный зев','Эустома','Орнитогалум','Амарант']},
{id:'sv-dvoinoi', cat:'svadba', name:'Букет и дублёр', price:8000, img:'img/svadba/b-dvoinoi.jpg',
...
{id:'pastel-21', cat:'shar', name:'Пастельная связка', price:3150, img:'img/shary/pastel-21.jpg',
 comp:['21 шар','Цифра','Фигурные шары','11 гелиевых шаров'],
 lead:'Готовая связка на день рождения: цифра, фигурные шары и одиннадцать гелиевых в пастельной гамме. Держатся до трёх недель.'},
